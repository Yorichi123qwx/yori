let handler = m => m; 
 ...
   let responses; 
   if (/^يوريتشي بحبك|يوريتشي عاوز اتجوزك|بحبك|بموت فيك|نتجوز|يوريتشي هنتجوز امتي|يوري انت ليا|يوري بموت فيك$/i.test(m.text)) { 
     responses = [ 
       '*و أنا أكثر يعمري🫶🏻💗*   ',  
       '*حبتك حية قول آمين!*',  
 ...
     ]; 
   }else if (/^ يوري عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشباب$/i.test(m.text)) { 
     responses = [ 
 ...
                   '*يسلمك و يسمنك🙏🏻*' 
   ...
   }else if (/^يوري|يوريتشي عمك|يا يوريتشي $/i.test(m.text)) { 
     responses = [ 
       'عيون يوريتشي 🫶🏻',  
          'لبيهه🥹',  
              'يهلا يهلا🫶🏻',  
